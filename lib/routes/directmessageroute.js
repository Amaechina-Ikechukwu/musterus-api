...
dmrouter.post("/sendDM", (0, authmiddleware_1.checkRequestBodyParams)(["conversationid", "message"]), verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
