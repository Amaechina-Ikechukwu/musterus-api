...
grouprouter.post("/updategroup", (0, authmiddleware_1.checkRequestBodyParams)(["name", "description", "photourl"]), verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
...
grouprouter.post("/message", (0, authmiddleware_1.checkRequestBodyParams)(["message", "groupid"]), verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield (0, SendMessage_1.default)(uid, groupid, message);
        res.status(200).json({ message: result });
    }
    catch (err) {
        if (err instanceof CustomUserProfileError) {
...
grouprouter.post("/likepost", (0, authmiddleware_1.checkRequestBodyParams)(["postid"]), verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
        const { postid } = req.body;
        const result = yield (0, LikePost_1.default)(uid, postid);
        res.status(200).json({ message: result });
    }
    catch (err) {
        if (err instanceof CustomUserProfileError) {
