...
const getsameschool_1 = __importDefault(require("../controllers/groups/getsameschool"));
const getsamefaculty_1 = __importDefault(require("../controllers/groups/getsamefaculty"));
const getsamedepartment_1 = __importDefault(require("../controllers/groups/getsamedepartment"));
const getsamelevel_1 = __importDefault(require("../controllers/groups/getsamelevel"));
...
profilerouter.get("/connect", verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
        const schoolmates = yield (0, getsameschool_1.default)(uid);
        const facultymates = yield (0, getsamefaculty_1.default)(uid);
        const departmentmates = yield (0, getsamedepartment_1.default)(uid);
        const coursemates = yield (0, getsamelevel_1.default)(uid);
        const connect = {
