...
const GetMyPost_1 = __importDefault(require("../controllers/profile/GetMyPost"));
const GetUserFriendsBirthdays_1 = require("../controllers/profile/GetUserFriendsBirthdays");
...
profilerouter.get("/myposts", verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
        const result = yield (0, GetMyPost_1.default)(uid);
...
profilerouter.get("/birthdays", verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
        const result = yield (0, GetUserFriendsBirthdays_1.getUserFriendsBirthdays)(uid);
