...
const sendmessage_1 = __importDefault(require("../controllers/groups/messaging/school/sendmessage"));
const seenby_1 = __importDefault(require("../controllers/groups/messaging/school/seenby"));
...
//
messagingRouter.post("/message/sendtoschoolgroup", (0, authmiddleware_1.checkRequestBodyParams)(["message"]), verifytoken_1.VerifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const uid = req.uid;
        const { message } = req.body;
        const result = yield (0, sendmessage_1.default)(uid, message);
