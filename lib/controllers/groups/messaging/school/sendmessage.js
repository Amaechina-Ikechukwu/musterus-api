...
function SendMessageToSchoolGroup(uid, message) {
    return __awaiter(this, void 0, void 0, function* () {
        const firestore = (0, firestore_1.getFirestore)();
        try {
            const { school, faculty, department, level } = yield (0, getuserprofileinformation_1.default)(uid);
            ...
            yield groupsRef
                ...
                .collection("chats")
                .doc()
                .set({ from: uid, message, sent: firestore_1.FieldValue.serverTimestamp() });
            return "sent";
        }
        catch (error) {
            console.log(error);
...
exports.default = SendMessageToSchoolGroup;
