    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const postsPromises = querySnapshot.docs.map((doc) => __awaiter(this, void 0, void 0, function* () {
                ...
                const likesQuerySnapshot = yield firestore
                    .collection("posts")
                    .doc(postid)
                    .collection("likes")
                    .get();
                const likesCount = likesQuerySnapshot.size;
                const currentUserLiked = likesQuerySnapshot.docs.some((likeDoc) => likeDoc.id === uid);
                // Fetch comments count
                const commentsQuerySnapshot = yield firestore
                    .collection("posts")
                    .doc(postid)
                    .collection("comments")
                    .get();
