...
function GetUsersPosts(uid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const userFriends = yield (0, GetUserFriends_1.default)(uid); // Await GetUserFriends function
            ...
            const postsPromises = querySnapshot.docs.map((doc) => __awaiter(this, void 0, void 0, function* () {
                ...
                const authorinfo = yield (0, getuserprofileinformation_1.default)(doc.data().author);
